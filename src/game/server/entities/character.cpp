...
{
	if(Weapon == 6 && g_Config.m_SvLaserjumps == 1 && g_Config.m_SvMode != 1 && From != m_pPlayer->GetCID())
		return false;
...
{
	Spree++;
	if (m_aWeapons[WEAPON_RIFLE].m_Ammo != 10) m_Armor++;
	if (m_Armor > 10)
	{
		if (m_aWeapons[WEAPON_RIFLE].m_Ammo < 10) m_aWeapons[WEAPON_RIFLE].m_Ammo++;
