...
MACRO_CONFIG_INT(SvKillingSpree, sv_spree, 0, 0, 1, CFGFLAG_SERVER, "Enable Killing-spree massage")
MACRO_CONFIG_INT(SvLaserjumps, sv_laserjumps, 0, 0, 1, CFGFLAG_SERVER, "Enable laserjumps 1-self 2-all")
MACRO_CONFIG_INT(SvWallshot, sv_wallshot, 0, 0, 1, CFGFLAG_SERVER, "Wallshot only")
MACRO_CONFIG_INT(SvExplosion, sv_explosion, 0 ,0, 1, CFGFLAG_SERVER, "Show Explosion while laserjumps enabled")

MACRO_CONFIG_INT(SvMode, sv_mode,0,0,3,CFGFLAG_SERVER,"0-Lazer 1-Grenade 2-Hammer 3-Ninja")
// debug
